<header class="sticky top-0 z-30 bg-white/70 dark:bg-gray-900/60 backdrop-blur-xl border-b border-gray-200 dark:border-gray-700/60 transition-all duration-300">
    <div class="h-18 px-4 sm:px-6 lg:px-8 flex items-center justify-between py-3">
        ...
        <div class="hidden lg:flex items-center gap-2">
            ...
            <a href="{{ route('domain-mappings.index') }}" title="نقشه‌برداری دامنه" class="inline-flex items-center justify-center w-11 h-11 rounded-2xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-gray-600 dark:text-gray-300 hover:shadow-lg hover:border-indigo-500/50 transition-all duration-300 focus:outline-none focus:ring-0 {{ request()->routeIs('domain-mappings.*') ? 'text-indigo-600 shadow-lg border-indigo-500/50' : '' }}">
